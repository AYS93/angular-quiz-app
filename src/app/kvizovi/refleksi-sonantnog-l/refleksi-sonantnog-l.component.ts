...
@Component({
  ...
  templateUrl: './refleksi-sonantnog-l.component.html',
  styleUrls: ['./refleksi-sonantnog-l.component.scss']
})
export class RefleksiSonantnogLComponent implements OnInit {
  ...
  getAllQuestions() {
    this.refleksiSonantnogLService.getQuestionJSON().subscribe(res => {
