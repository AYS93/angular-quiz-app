...
@Component({
  selector: 'app-ptice',
  templateUrl: './ptice.component.html',
  styleUrls: ['./ptice.component.scss']
})
export class PticeComponent implements OnInit {
  ...
  constructor(private pticeService: PticeService) { }
  ...
  getAllQuestions() {
    this.pticeService.getQuestionJSON().subscribe(res => {
