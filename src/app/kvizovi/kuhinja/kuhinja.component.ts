...
@Component({
  ...
  templateUrl: './kuhinja.component.html',
  styleUrls: ['./kuhinja.component.scss']
})
export class KuhinjaComponent implements OnInit {
  ...
  interval$: any; // $ sign = observable
  progress: string = "0";
  isQuizCompleted: boolean = false;
  i = 0;

  constructor(private kuhinjaService: KuhinjaService) { }
  ...
  getAllQuestions() {
    this.kuhinjaService.getQuestionJSON().subscribe(res => {
