...
@Component({
  ...
  templateUrl: './glagol-jesam.component.html',
  styleUrls: ['./glagol-jesam.component.scss']
})
export class GlagolJesamComponent implements OnInit {
  ...
  constructor(private glagolJesamService: GlagolJesamService) { }
  ...
  getAllQuestions() {
    this.glagolJesamService.getQuestionJSON().subscribe(res => {
